...
let originalCharacterList = [...characterList];
...
function runTwice(func) {
    ...
    setTimeout(()=> {
        ...
        // characterList = [...originalCharacterList]; // restore the array to its original state
    }, 10000)
    // }, 500 * rand + 3000);
}
...
function characterPicker() {
    ...
    function characterTimer(min, max) {
        ...
        // let character = characterList[randomIndex];
        ...
        let newCharacterList = characterList.filter((value, index) => index !== randomIndex);
